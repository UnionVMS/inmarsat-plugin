...
public class PluginAckEventBusListener implements MessageListener {
  ...
  @EJB private InmarsatPlugin startupService;

  @Override
  public void onMessage(Message inMessage) {

    LOGGER.info(
        "Eventbus listener for twostage at selector: {} got a message",
        startupService.getPluginResponseSubscriptionName());
      ...
      if (request == null) {
        ...
        switch (request.getMethod()) {
          case REGISTER_SERVICE:
            RegisterServiceResponse registerResponse =
                JAXBMarshaller.unmarshallTextMessage(textMessage, RegisterServiceResponse.class);
            ...
            switch (registerResponse.getAck().getType()) {
              case OK:
                ...
                startupService.updateSettings(
                    registerResponse.getService().getSettingList().getSetting());
                break;
              case NOK:
          ...
          case UNREGISTER_SERVICE:
            UnregisterServiceResponse unregisterResponse =
                JAXBMarshaller.unmarshallTextMessage(textMessage, UnregisterServiceResponse.class);
