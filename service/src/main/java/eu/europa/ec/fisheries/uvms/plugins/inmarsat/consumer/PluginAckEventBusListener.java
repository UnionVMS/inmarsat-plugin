...
public class PluginAckEventBusListener implements MessageListener {
    ...
    public void onMessage(Message inMessage) {
        ...
        LOG.info("Eventbus listener for twostage at selector: {} got a message", startupService.getPluginResponseSubscriptionName());
        ...
        try {
            ...
            LOG.error("[ Error when receiving message in twostage ]", e);
        }
    }
